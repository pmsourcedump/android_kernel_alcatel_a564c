...
#ifdef CONFIG_PROJECT_SOUL35EVDO //add by qian.zhou
			   ...
			   unsigned long *nr)
{
	 ...
	 */
#ifdef CONFIG_PROJECT_SOUL35EVDO //modified by qian.zhou
	 // merge from MTK platform  for swap optimize zhengwei.zheng 2014-03-05 begin
#ifdef CONFIG_ZRAM
...
#endif	//CONFIG_ZRAM
#else // CONFIG_PROJECT_SOUL35EVDO
	anon_prio = vmscan_swappiness(sc);
	file_prio = 200 - vmscan_swappiness(sc);
#endif // CONFIG_PROJECT_SOUL35EVDO
	// merge from MTK platform  for swap optimize zhengwei.zheng 2014-03-05 end
