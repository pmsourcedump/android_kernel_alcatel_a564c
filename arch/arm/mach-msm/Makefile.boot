...
#[PLATFORM]-Add-BEGIN by TCTSZ.cuiping.shi, for diff project use diff dts files, 2014/03/28
#ifdef CONFIG_PROJECT_YARIS5NA
#        dtb-$(CONFIG_ARCH_MSM8610)      += msm8610-v2-qrd-skuaa_yaris5na.dtb
#endif
ifdef CONFIG_PROJECT_SOUL35EVDO
        dtb-$(CONFIG_ARCH_MSM8610)      += msm8610-v2-qrd-skuaa_soul35evdo.dtb
#[PLATFORM]-Add-BEGIN by TCTHZ xiaopu.zhu, for soul35EVDO project 2014/03/28
else
	dtb-$(CONFIG_ARCH_MSM8610)      += msm8610-v2-qrd-skuaa_yaris5na.dtb
endif
#[PLATFORM]-Add-END by TCTSZ.cuiping.shi, 2014/03/28
