...
//Begin add by xiaopu.zhu for soul3.5EVDO camera VANA power, 20140402.
	{
		.gpio = 43, /* VANA 2.8v power en 7 old*/
		.settings = {
			[GPIOMUX_ACTIVE]	= &cam_settings[3],
			[GPIOMUX_SUSPENDED] = &gpio_suspend_config[1],
		},
	},
//End add by xiaopu.zhu for soul3.5EVDO camera VANA power, 20140402.
