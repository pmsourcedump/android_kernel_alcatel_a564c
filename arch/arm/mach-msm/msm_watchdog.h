...
//add by chenghui.jia for test watchdog dump
...
#else
//end by chenghui.jia for test watchdog dump
#ifdef CONFIG_MSM_WATCHDOG
void pet_watchdog(void);
void msm_watchdog_reset(unsigned int timeout);    //add by chenghui.jia for test watchdog dump
#else
static inline void pet_watchdog(void) { }
static inline void msm_watchdog_reset(unsigned int timeout) { }    //add by chenghui.jia for test watchdog dump
#endif
#endif  //add by chenghui.jia for test watchdog dump
#endif
