		 ...
		 size_t len, int noblock, int flags, int *addr_len)
{
	...
	if (family == AF_INET) {
		...
		/*merged by zhiling.chen  form google security patch CVE-2013-6432 */
     ...
     /*end merged by zhiling.chen  form google security patch CVE-2013-6432 */
    ...
    */
		if (sin6) {
			...
			sin6->sin6_flowinfo = 0;
			if (np->sndflow)
				sin6->sin6_flowinfo = *(__be32 *)ip6 & IPV6_FLOWINFO_MASK;
			sin6->sin6_scope_id =
