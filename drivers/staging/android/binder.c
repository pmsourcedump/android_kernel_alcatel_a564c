			       ...
			       struct binder_transaction_data *tr, int reply)
{
	...
	uint32_t return_error;
	  /*merged by zhiling.chen  form google security patch ANDROID-11355082 */
  size_t off_min;
     /*end merged by zhiling.chen  form google security patch ANDROID-11355082 */
	...
	off_min = 0;   /*merged by zhiling.chen  form google security patch ANDROID-11355082 */
	for (; offp < off_end; offp++) {
		struct flat_binder_object *fp;
		if (*offp > t->buffer->data_size - sizeof(*fp) ||
			  *offp < off_min ||   /*merged by zhiling.chen  form google security patch ANDROID-11355082 */
	...
	/* end merged by zhiling.chen  form google security patch ANDROID-11355082 */				  
		...
		off_min = *offp + sizeof(struct flat_binder_object); /*merged by zhiling.chen  form google security patch ANDROID-11355082 */
		switch (fp->type) {
		case BINDER_TYPE_BINDER:
		case BINDER_TYPE_WEAK_BINDER: {
			struct binder_ref *ref;
