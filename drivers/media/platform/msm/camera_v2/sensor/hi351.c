...
#define HI351MIPI_SENSOR_NAME "hi351MIPI"
#define PLATFORM_DRIVER_NAME "msm_camera_hi351MIPI"
...
DEFINE_MSM_MUTEX(hi351MIPI_mut);
static struct msm_sensor_ctrl_t hi351MIPI_s_ctrl;

static struct msm_sensor_power_setting hi351MIPI_power_setting[] = {
	{
...
static struct msm_camera_i2c_reg_conf hi351MIPI_qxga_settings[] = {
...
static struct msm_camera_i2c_reg_conf hi351MIPI_start_settings[] = {
	{0x03, 0x00},
	{0x01, 0xf0},
};

static struct msm_camera_i2c_reg_conf hi351MIPI_stop_settings[] = {
	{0x03, 0x00},
	{0x01, 0xf1},
};

static struct msm_camera_i2c_reg_conf hi351MIPI_recommend_settings[] = {
	{0x03, 0x00},
...
{0x2c, 0x88}, //SATB_01
{0x2d, 0x88}, //SATB_02
{0x2e, 0x70}, //SATB_03  //88 jacky  80
{0x2f, 0x98}, //SATB_04   //95 //a8
{0x30, 0xc0}, //SATB_05  //b8  //c5
{0x31, 0x80}, //SATB_06   // 90
{0x32, 0x88}, //SATB_07   //90  9a
{0x33, 0x98}, //SATB_08    //a0  a8
{0x34, 0x90}, //SATB_09
{0x35, 0x90}, //SATB_10
{0x36, 0x90}, //SATB_11
//Cr
...
{0x38, 0x88}, //SATR_01
{0x39, 0x88}, //SATR_02
{0x3a, 0x78}, //SATR_03   //90 jacky  8a
{0x3b, 0xa0}, //SATR_04  //95   //ab
{0x3c, 0x98}, //SATR_05   //98    aa
{0x3d, 0x88}, //SATR_06    //90
{0x3e, 0x88}, //SATR_07  //90  //95
{0x3f, 0x90}, //SATR_08   //90   98
{0x40, 0x90}, //SATR_09
{0x41, 0x90}, //SATR_10
{0x42, 0x90}, //SATR_11
...
{0x3c, 0x90}, //LSC 04 Gain B   //88
{0x3d, 0x88}, //LSC 04 Gain R   //jacky 80
...
{0x44, 0x90},//LSC 05 Gain B  //80jacky
...
{0x5c, 0x90}, //LSC 08 Gain B  //80
{0x5d, 0x90}, //LSC 08 Gain R
...
{0x64, 0x90}, //LSC 09 Gain B  jacky 80
{0x65, 0x88}, //LSC 09 Gain R  jacky 80
...
{0x6c, 0x90}, //LSC 10 Gain B  //jacky80
...
{0x74, 0x90}, //LSC 11 Gain B  //jacky 80
{0x75, 0x90}, //LSC 11 Gain R
...
static struct v4l2_subdev_info hi351MIPI_subdev_info[] = {
	{
...
static struct msm_camera_i2c_reg_conf hi351MIPI_xga_settings[] = {
	{0x03, 0x00},
{0x01, 0xf1},//Sleep on
...
static struct msm_camera_i2c_reg_conf hi351MIPI_sleep_settings[] = {
...
static struct msm_camera_i2c_reg_conf HI351MIPI_reg_saturation[11][25] = {
	{
   ...
   {0x2c, 0x88}, /*SATB_01*/
   {0x2d, 0x88}, /*SATB_02*/
   {0x2e, 0x75}, /*SATB_03*/  //88 
   {0x2f, 0x75}, /*SATB_04*/   //88
   {0x30, 0xb8}, /*SATB_05*/   //bc
   {0x31, 0x88}, /*SATB_06*/   //98
   {0x32, 0x80}, /*SATB_07*/    //98
   {0x33, 0x93}, /*SATB_08*/    //98
   {0x34, 0x90}, /*SATB_09*/    
   {0x35, 0x90}, /*SATB_10*/
   {0x36, 0x98}, /*SATB_11*/
   /*SATR*/
   ...
   {0x38, 0x80}, /*SATR_01*/
   {0x39, 0x80}, /*SATR_02*/
   {0x3a, 0x70}, /*SATR_03*/    //78
   {0x3b, 0x78}, /*SATR_04*/     //88
   {0x3c, 0xb4}, /*SATR_05*/     //b4
   {0x3d, 0x75}, /*SATR_06*/   //8c
   {0x3e, 0x75}, /*SATR_07*/   //8c
   {0x3f, 0x8c}, /*SATR_08*/
   {0x40, 0x80}, /*SATR_09*/
   {0x41, 0x80}, /*SATR_10*/
   {0x42, 0x8c}, /*SATR_11*/
	...
	{
		{0x03, 0xd1}, /*page D1(Adaptive)*/ //default  //6
   /*SATB*/
   {0x2b, 0x88}, /*SATB_00*/
   {0x2c, 0x88}, /*SATB_01*/
   {0x2d, 0x88}, /*SATB_02*/
   {0x2e, 0x78}, /*SATB_03*/  //88 
   {0x2f, 0x7a}, /*SATB_04*/   //88
   {0x30, 0xb8}, /*SATB_05*/   //bc
   {0x31, 0x80}, /*SATB_06*/   //98
   {0x32, 0x85}, /*SATB_07*/    //98
   {0x33, 0x93}, /*SATB_08*/    //98
   {0x34, 0x90}, /*SATB_09*/    
   {0x35, 0x90}, /*SATB_10*/
   {0x36, 0x98}, /*SATB_11*/
   ...
   {0x39, 0x80}, /*SATR_02*/
   {0x3a, 0x70}, /*SATR_03*/    //78
   {0x3b, 0x80}, /*SATR_04*/     //88
   {0x3c, 0xb4}, /*SATR_05*/     //b4
   {0x3d, 0x78}, /*SATR_06*/   //8c
   {0x3e, 0x80}, /*SATR_07*/   //8c
   {0x3f, 0x8c}, /*SATR_08*/
   {0x40, 0x80}, /*SATR_09*/
   {0x41, 0x85}, /*SATR_10*/
   {0x42, 0x8c}, /*SATR_11*/
...
static struct msm_camera_i2c_reg_conf HI351MIPI_reg_contrast[11][3] = {
	{
		{0x03, 0xd9},
		{0x19, 0x58},
...
static struct msm_camera_i2c_reg_conf HI351MIPI_reg_sharpness[7][32] = {
	{
   {0x03, 0xdb},
   {0x37, 0x08}, //Out
   {0xbb, 0x10}, //Pos_H
...
static struct msm_camera_i2c_reg_conf HI351MIPI_reg_iso[7][38] = {
	/* auto */
	{
	{0x03, 0xc4},
   {0x10, 0x60},
...
static struct msm_camera_i2c_reg_conf HI351MIPI_reg_exposure_compensation[5][15] = {
	/* -2 */
	{
		{0x03, 0xcf},
   {0x3f, 0x18}, /*YLVL_00*/
...
{0x40, 0x30},//YLVL_01
{0x41, 0x30},//YLVL_02
{0x42, 0x35},//YLVL_03  //30 jacky
{0x43, 0x35},//YLVL_04
{0x44, 0x35},//YLVL_05
{0x45, 0x35},//YLVL_06  //38
{0x46, 0x35},//YLVL_07
{0x47, 0x35},//YLVL_08
{0x48, 0x35},//YLVL_09
{0x49, 0x35},//YLVL_10
...
static struct msm_camera_i2c_reg_conf HI351MIPI_reg_antibanding[][14] = {
	/* OFF */
	{
{0x03, 0xc4},//AE en
...
static struct msm_camera_i2c_reg_conf HI351MIPI_reg_effect_normal[] = {
	/* normal: */
...
static struct msm_camera_i2c_reg_conf HI351MIPI_reg_effect_black_white[] = {
	/* B&W: */
...
static struct msm_camera_i2c_reg_conf HI351MIPI_reg_effect_negative[] = {
	/* Negative: */
...
static struct msm_camera_i2c_reg_conf HI351MIPI_reg_effect_old_movie[] = {
	/* Sepia(antique): */
...
static struct msm_camera_i2c_reg_conf HI351MIPI_reg_effect_solarize[] = {
...
static struct msm_camera_i2c_reg_conf HI351MIPI_reg_scene_auto[] = {
	/* <SCENE_auto> */
...
static struct msm_camera_i2c_reg_conf HI351MIPI_reg_scene_portrait[] = {
...
static struct msm_camera_i2c_reg_conf HI351MIPI_reg_scene_landscape[] = {
...
static struct msm_camera_i2c_reg_conf HI351MIPI_reg_scene_night[] = {
	/* <SCENE_NIGHT> */
...
static struct msm_camera_i2c_reg_conf HI351MIPI_reg_wb_auto[] = {
	/* Auto: */
...
static struct msm_camera_i2c_reg_conf HI351MIPI_reg_wb_sunny[] = {
	/* Sunny: */
...
static struct msm_camera_i2c_reg_conf HI351MIPI_reg_wb_cloudy[] = {
	/* Cloudy: */
...
static struct msm_camera_i2c_reg_conf HI351MIPI_reg_wb_office[] = {
	/* Office: */
...
static struct msm_camera_i2c_reg_conf HI351MIPI_reg_wb_home[] = {
	/* Home: */
...
static const struct i2c_device_id hi351MIPI_i2c_id[] = {
	{HI351MIPI_SENSOR_NAME, (kernel_ulong_t)&hi351MIPI_s_ctrl},
	{ }
};

static int32_t msm_hi351MIPI_i2c_probe(struct i2c_client *client,
	   const struct i2c_device_id *id)
{
	   return msm_sensor_i2c_probe(client, id, &hi351MIPI_s_ctrl);
}

static struct i2c_driver hi351MIPI_i2c_driver = {
	.id_table = hi351MIPI_i2c_id,
	.probe  = msm_hi351MIPI_i2c_probe,
	.driver = {
		.name = HI351MIPI_SENSOR_NAME,
	},
};

static struct msm_camera_i2c_client hi351MIPI_sensor_i2c_client = {
	.addr_type = MSM_CAMERA_I2C_BYTE_ADDR,
};

static const struct of_device_id hi351MIPI_dt_match[] = {
	{.compatible = "shinetech,hi351MIPI", .data = &hi351MIPI_s_ctrl},
	{}
};

MODULE_DEVICE_TABLE(of, hi351MIPI_dt_match);

static struct platform_driver hi351MIPI_platform_driver = {
	.driver = {
		.name = "shinetech,hi351MIPI",
		.owner = THIS_MODULE,
		.of_match_table = hi351MIPI_dt_match,
	},
};

static void hi351MIPI_i2c_write_table(struct msm_sensor_ctrl_t *s_ctrl,
...
static int32_t hi351MIPI_sensor_power_down(struct msm_sensor_ctrl_t *s_ctrl)
{
	hi351MIPI_i2c_write_table(s_ctrl, &hi351MIPI_sleep_settings[0],
		ARRAY_SIZE(hi351MIPI_sleep_settings));
	return msm_sensor_power_down(s_ctrl);
}

static int32_t hi351MIPI_platform_probe(struct platform_device *pdev)
{
	int32_t rc;
	const struct of_device_id *match;
	match = of_match_device(hi351MIPI_dt_match, &pdev->dev);
	rc = msm_sensor_platform_probe(pdev, match->data);
	return rc;
}

static int __init hi351MIPI_init_module(void)
{
	int32_t rc;
	pr_info("%s:%d platform_driver_probe\n", __func__, __LINE__);
	rc = platform_driver_probe(&hi351MIPI_platform_driver,
		hi351MIPI_platform_probe);
	if (!rc)
		return rc;

	rc = i2c_add_driver(&hi351MIPI_i2c_driver);
	pr_info("%s:%d i2c_add_driver rc = %d\n", __func__, __LINE__, rc);		
	return rc;
}

static void __exit hi351MIPI_exit_module(void)
{
	pr_info("%s:%d\n", __func__, __LINE__);
	if (hi351MIPI_s_ctrl.pdev) {
		msm_sensor_free_sensor_data(&hi351MIPI_s_ctrl);
		platform_driver_unregister(&hi351MIPI_platform_driver);
	} else
		i2c_del_driver(&hi351MIPI_i2c_driver);
	return;
}

static int32_t hi351MIPI_sensor_match_id(struct msm_sensor_ctrl_t *s_ctrl)
{
	int32_t rc = 0;
	uint16_t chipid = 0;
	...
	if (rc < 0) {
		pr_err("%s: %s: hi351MIPI read id failed\n", __func__,
...
static void hi351MIPI_set_stauration(struct msm_sensor_ctrl_t *s_ctrl, int value)
{
	pr_debug("%s %d", __func__, value);
	hi351MIPI_i2c_write_table(s_ctrl, &HI351MIPI_reg_saturation[value][0],
		ARRAY_SIZE(HI351MIPI_reg_saturation[value]));
}

static void hi351MIPI_set_contrast(struct msm_sensor_ctrl_t *s_ctrl, int value)
{
	pr_debug("%s %d", __func__, value);
	hi351MIPI_i2c_write_table(s_ctrl, &HI351MIPI_reg_contrast[value][0],
		ARRAY_SIZE(HI351MIPI_reg_contrast[value]));
}

static void hi351MIPI_set_sharpness(struct msm_sensor_ctrl_t *s_ctrl, int value)
{
	int val = value / 6;
	pr_debug("%s %d", __func__, value);
	hi351MIPI_i2c_write_table(s_ctrl, &HI351MIPI_reg_sharpness[val][0],
		ARRAY_SIZE(HI351MIPI_reg_sharpness[val]));
}


static void hi351MIPI_set_iso(struct msm_sensor_ctrl_t *s_ctrl, int value)
{
	pr_debug("%s %d", __func__, value);
	hi351MIPI_i2c_write_table(s_ctrl, &HI351MIPI_reg_iso[value][0],
		ARRAY_SIZE(HI351MIPI_reg_iso[value]));
}

static void hi351MIPI_set_exposure_compensation(struct msm_sensor_ctrl_t *s_ctrl,
	int value)
{
	int val = (value + 12) / 6;
	pr_debug("%s %d", __func__, val);
	hi351MIPI_i2c_write_table(s_ctrl, &HI351MIPI_reg_exposure_compensation[val][0],
		ARRAY_SIZE(HI351MIPI_reg_exposure_compensation[val]));
}

static void hi351MIPI_set_effect(struct msm_sensor_ctrl_t *s_ctrl, int value)
{
	pr_debug("%s %d", __func__, value);
	switch (value) {
	case MSM_CAMERA_EFFECT_MODE_OFF: {
		hi351MIPI_i2c_write_table(s_ctrl, &HI351MIPI_reg_effect_normal[0],
			ARRAY_SIZE(HI351MIPI_reg_effect_normal));
		break;
	}
	case MSM_CAMERA_EFFECT_MODE_MONO: {
		hi351MIPI_i2c_write_table(s_ctrl, &HI351MIPI_reg_effect_black_white[0],
			ARRAY_SIZE(HI351MIPI_reg_effect_black_white));
		break;
	}
	case MSM_CAMERA_EFFECT_MODE_NEGATIVE: {
		hi351MIPI_i2c_write_table(s_ctrl, &HI351MIPI_reg_effect_negative[0],
			ARRAY_SIZE(HI351MIPI_reg_effect_negative));
		break;
	}
	case MSM_CAMERA_EFFECT_MODE_SEPIA: {
		hi351MIPI_i2c_write_table(s_ctrl, &HI351MIPI_reg_effect_old_movie[0],
			ARRAY_SIZE(HI351MIPI_reg_effect_old_movie));
		break;
	}
	case MSM_CAMERA_EFFECT_MODE_SOLARIZE: {
		hi351MIPI_i2c_write_table(s_ctrl, &HI351MIPI_reg_effect_solarize[0],
			ARRAY_SIZE(HI351MIPI_reg_effect_solarize));
		break;
	}
	default:
		hi351MIPI_i2c_write_table(s_ctrl, &HI351MIPI_reg_effect_normal[0],
...
static void hi351MIPI_set_antibanding(struct msm_sensor_ctrl_t *s_ctrl, int value)
{
	pr_debug("%s %d", __func__, value);
	hi351MIPI_i2c_write_table(s_ctrl, &HI351MIPI_reg_antibanding[value][0],
		ARRAY_SIZE(HI351MIPI_reg_antibanding[value]));
}

static void hi351MIPI_set_scene_mode(struct msm_sensor_ctrl_t *s_ctrl, int value)
{
	pr_debug("%s %d", __func__, value);
	switch (value) {
	case MSM_CAMERA_SCENE_MODE_OFF: {
		hi351MIPI_i2c_write_table(s_ctrl, &HI351MIPI_reg_scene_auto[0],
			ARRAY_SIZE(HI351MIPI_reg_scene_auto));
		break;
	}
	case MSM_CAMERA_SCENE_MODE_NIGHT: {
		hi351MIPI_i2c_write_table(s_ctrl, &HI351MIPI_reg_scene_night[0],
			ARRAY_SIZE(HI351MIPI_reg_scene_night));
					break;
	}
	case MSM_CAMERA_SCENE_MODE_LANDSCAPE: {
		hi351MIPI_i2c_write_table(s_ctrl, &HI351MIPI_reg_scene_landscape[0],
			ARRAY_SIZE(HI351MIPI_reg_scene_landscape));
		break;
	}
	case MSM_CAMERA_SCENE_MODE_PORTRAIT: {
		hi351MIPI_i2c_write_table(s_ctrl, &HI351MIPI_reg_scene_portrait[0],
			ARRAY_SIZE(HI351MIPI_reg_scene_portrait));
		break;
	}
	default:
		hi351MIPI_i2c_write_table(s_ctrl, &HI351MIPI_reg_scene_auto[0],
...
static void hi351MIPI_set_white_balance_mode(struct msm_sensor_ctrl_t *s_ctrl,
	int value)
{
	pr_debug("%s %d", __func__, value);
	switch (value) {
	case MSM_CAMERA_WB_MODE_AUTO: {
		hi351MIPI_i2c_write_table(s_ctrl, &HI351MIPI_reg_wb_auto[0],
			ARRAY_SIZE(HI351MIPI_reg_wb_auto));
		break;
	}
	case MSM_CAMERA_WB_MODE_INCANDESCENT: {
		hi351MIPI_i2c_write_table(s_ctrl, &HI351MIPI_reg_wb_home[0],
			ARRAY_SIZE(HI351MIPI_reg_wb_home));
		break;
	}
	case MSM_CAMERA_WB_MODE_DAYLIGHT: {
		hi351MIPI_i2c_write_table(s_ctrl, &HI351MIPI_reg_wb_sunny[0],
			ARRAY_SIZE(HI351MIPI_reg_wb_sunny));
					break;
	}
	case MSM_CAMERA_WB_MODE_FLUORESCENT: {
		hi351MIPI_i2c_write_table(s_ctrl, &HI351MIPI_reg_wb_office[0],
			ARRAY_SIZE(HI351MIPI_reg_wb_office));
					break;
	}
	case MSM_CAMERA_WB_MODE_CLOUDY_DAYLIGHT: {
		hi351MIPI_i2c_write_table(s_ctrl, &HI351MIPI_reg_wb_cloudy[0],
			ARRAY_SIZE(HI351MIPI_reg_wb_cloudy));
					break;
	}
	default:
		hi351MIPI_i2c_write_table(s_ctrl, &HI351MIPI_reg_wb_auto[0],
...
int32_t hi351MIPI_sensor_config(struct msm_sensor_ctrl_t *s_ctrl,
	void __user *argp)
{
	...
	case CFG_SET_INIT_SETTING:
		CDBG("init setting");
		hi351MIPI_i2c_write_table(s_ctrl,
				&hi351MIPI_recommend_settings[0],
				ARRAY_SIZE(hi351MIPI_recommend_settings));
		CDBG("init setting X");
		break;
	case CFG_SET_RESOLUTION: {
		...
		if (val == 0)
			hi351MIPI_i2c_write_table(s_ctrl, &hi351MIPI_qxga_settings[0],
				ARRAY_SIZE(hi351MIPI_qxga_settings));
		else if (val == 1)
			hi351MIPI_i2c_write_table(s_ctrl, &hi351MIPI_xga_settings[0],
				ARRAY_SIZE(hi351MIPI_xga_settings));
		break;
	}
	case CFG_SET_STOP_STREAM:
		hi351MIPI_i2c_write_table(s_ctrl,
			&hi351MIPI_stop_settings[0],
			ARRAY_SIZE(hi351MIPI_stop_settings));
		break;
	case CFG_SET_START_STREAM:
		hi351MIPI_i2c_write_table(s_ctrl,
			&hi351MIPI_start_settings[0],
			ARRAY_SIZE(hi351MIPI_start_settings));
		break;
	...
	case CFG_SET_SATURATION: {
		...
		hi351MIPI_set_stauration(s_ctrl, sat_lev);
		break;
	}
	case CFG_SET_CONTRAST: {
		...
		hi351MIPI_set_contrast(s_ctrl, con_lev);
		break;
	}
	case CFG_SET_SHARPNESS: {
		...
		hi351MIPI_set_sharpness(s_ctrl, shp_lev);
		break;
	}
	case CFG_SET_ISO: {
		int32_t iso_lev;
		...
		hi351MIPI_set_iso(s_ctrl, iso_lev);
		break;
	}
	case CFG_SET_EXPOSURE_COMPENSATION: {
		...
		pr_debug("%s: Exposure compensation Value is %d",
			__func__, ec_lev);
		hi351MIPI_set_exposure_compensation(s_ctrl, ec_lev);
		break;
	}
	case CFG_SET_EFFECT: {
		int32_t effect_mode;
		...
		hi351MIPI_set_effect(s_ctrl, effect_mode);
		break;
	}
	case CFG_SET_ANTIBANDING: {
		...
		pr_debug("%s: anti-banding mode is %d", __func__,
			antibanding_mode);
		hi351MIPI_set_antibanding(s_ctrl, antibanding_mode);
		break;
	}
	case CFG_SET_BESTSHOT_MODE: {
		...
		hi351MIPI_set_scene_mode(s_ctrl, bs_mode);
		break;
	}
	case CFG_SET_WHITE_BALANCE: {
		...
		hi351MIPI_set_white_balance_mode(s_ctrl, wb_mode);
		break;
	}
	default:
		rc = -EFAULT;
...
static struct msm_sensor_fn_t hi351MIPI_sensor_func_tbl = {
	.sensor_config = hi351MIPI_sensor_config,
	.sensor_power_up = msm_sensor_power_up,
	.sensor_power_down = hi351MIPI_sensor_power_down,
	.sensor_match_id = hi351MIPI_sensor_match_id,
};

static struct msm_sensor_ctrl_t hi351MIPI_s_ctrl = {
	.sensor_i2c_client = &hi351MIPI_sensor_i2c_client,
	.power_setting_array.power_setting = hi351MIPI_power_setting,
	.power_setting_array.size = ARRAY_SIZE(hi351MIPI_power_setting),
	.msm_sensor_mutex = &hi351MIPI_mut,
	.sensor_v4l2_subdev_info = hi351MIPI_subdev_info,
	.sensor_v4l2_subdev_info_size = ARRAY_SIZE(hi351MIPI_subdev_info),
	.func_tbl = &hi351MIPI_sensor_func_tbl,
};

module_init(hi351MIPI_init_module);
module_exit(hi351MIPI_exit_module);
