...
#if 1
	gpio_set_value(data->gpio_conf->gpio_num_info->gpio_num[SENSOR_GPIO_RESET], GPIO_OUT_LOW);
	mdelay(5);
	gpio_set_value(data->gpio_conf->gpio_num_info->gpio_num[SENSOR_GPIO_RESET], GPIO_OUT_HIGH);
	mdelay(5);
	gpio_set_value(data->gpio_conf->gpio_num_info->gpio_num[SENSOR_GPIO_RESET], GPIO_OUT_LOW);
	gpio_set_value(data->gpio_conf->gpio_num_info->gpio_num[SENSOR_GPIO_STANDBY], GPIO_OUT_HIGH);
	gpio_set_value(data->gpio_conf->gpio_num_info->gpio_num[SENSOR_GPIO_VANA], GPIO_OUT_LOW);
#endif
