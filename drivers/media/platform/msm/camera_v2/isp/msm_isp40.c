	...
	enum msm_isp_camif_update_state update_state)
{
	...
	if (update_state == ENABLE_CAMIF) {
		...
		msm_camera_io_w_mb(0x4, vfe_dev->vfe_base + 0x2F4);	//patch by qiangbo.ni for burst shot vertical line issue 2014-05-26 
...
struct msm_vfe_hardware_info vfe40_hw_info = {
	...
	.vfe_ops = {
		...
		.core_ops = {
			...
			.get_overflow_mask = msm_vfe40_get_overflow_mask,	//patch by qiangbo.ni for burst shot vertical line issue 2014-05-26 begin
			.get_irq_mask = msm_vfe40_get_irq_mask,
			.restore_irq_mask = msm_vfe40_restore_irq_mask,
			.get_halt_restart_mask =
				msm_vfe40_get_halt_restart_mask,	//patch by qiangbo.ni for burst shot vertical line issue 2014-05-26 end
