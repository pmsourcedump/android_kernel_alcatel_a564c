...
struct msm_vfe_axi_ops {
	...
	long (*halt) (struct vfe_device *vfe_dev, uint32_t blocking);	//patch by qiangbo.ni for burst shot vertical line issue 2014-05-26
};

struct msm_vfe_core_ops {
	void (*reg_update) (struct vfe_device *vfe_dev);
	long (*reset_hw) (struct vfe_device *vfe_dev,
		enum msm_isp_reset_type reset_type, uint32_t blocking);	//patch by qiangbo.ni for burst shot vertical line issue 2014-05-26
	...
	void (*get_overflow_mask) (uint32_t *overflow_mask);	//patch by qiangbo.ni for burst shot vertical line issue 2014-05-26 begin
	...
	void (*get_halt_restart_mask) (uint32_t *irq0_mask,
		uint32_t *irq1_mask);//patch by qiangbo.ni for burst shot vertical line issue 2014-05-26 end
};
...
struct msm_vfe_axi_stream {
	...
	enum msm_vfe_frame_skip_pattern frame_skip_pattern;//patch by qiangbo.ni for burst shot vertical line issue 2014-05-26 begin
...
//patch by qiangbo.ni for burst shot vertical line issue 2014-05-26 end
...
struct msm_vfe_error_info {
	atomic_t overflow_state;	//patch by qiangbo.ni for burst shot vertical line issue 2014-05-26 begin
	uint32_t overflow_recover_irq_mask0;
	uint32_t overflow_recover_irq_mask1;	//patch by qiangbo.ni for burst shot vertical line issue 2014-05-26 end
