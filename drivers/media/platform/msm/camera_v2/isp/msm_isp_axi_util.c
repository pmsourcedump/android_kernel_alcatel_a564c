	...
	struct msm_vfe_axi_stream_request_cmd *stream_cfg_cmd)
{
	...
	stream_info->frame_skip_pattern =
			stream_cfg_cmd->frame_skip_pattern;	//patch by qiangbo.ni for burst shot vertical line issue 2014-05-26
...
//zrl delete for resolve camera capture crash issue,140227,begin
#if 0
...
#endif
//zrl delete for resolve camera capture crash issue,140227,end
